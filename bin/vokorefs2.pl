...
sub html_tree {
	...
	if (@{$entry->{'super'}}) {
		...
		print 
		    "<a href=\"".tez_file($v)."\">",
		    "<img src=\"../smb/s1.gif\" alt=\"".$smb{'super'}."\" border=0>",
		    "</a>\n";
#		print "[<a href=\"".tez_file($v)."\">...</a>]\n";
...
#		print "[<a href=\"".tez_file($v)."\">...</a>]\n";
	...
	if (@{$entry->{'sub'}}) {
		...
		print
		"<a href=\"".tez_file($v)."\">",
		"<img src=\"../smb/s2.gif\"  alt=\"".$smb{'sub'}."\" border=0>",
		"</a>\n";
		print "<a href=\"".word_ref($v)."\" target=\"precipa\">"
		    .$v->{'kap'}."</a>\n";
