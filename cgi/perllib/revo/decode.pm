...
#  $str =~ s/\x{#362}/&Umacr;/g;
  ...
  $str =~ s/&zin;/\x{0632}/g;
  $str =~ s/&sin;/\x{0633}/g;
  $str =~ s/&shin1;/\x{0634}/g;
  $str =~ s/&Sad;/\x{0635}/g;
  $str =~ s/&Dad;/\x{0636}/g;
  $str =~ s/&Ta;/\x{0637}/g;
  $str =~ s/&Za;/\x{0638}/g;
  $str =~ s/&ayn;/\x{0639}/g;
  $str =~ s/&ghayn;/\x{063A}/g;
  $str =~ s/&fa;/\x{0641}/g;
  $str =~ s/&qaf;/\x{0642}/g;
  $str =~ s/&kaf1;/\x{0643}/g;
  $str =~ s/&lam;/\x{0644}/g;
  ...
  $str =~ s/&fatha;/\x{064E}/g;
  $str =~ s/&kasra;/\x{0650}/g;
  $str =~ s/&damma;/\x{064F}/g;
  $str =~ s/&fatha_alif;/\x{064E}\x{0627}/g;
  $str =~ s/&kasra_ya;/\x{0650}\x{064A}/g;
  $str =~ s/&damma_waw;/\x{0648}\x{064F}/g;
  $str =~ s/&fathatan;/\x{064B}/g;
  $str =~ s/&kasratan;/\x{064D}/g;
  $str =~ s/&dammatan;/\x{064C}/g;
  $str =~ s/&sukun;/\x{0652}/g;
  $str =~ s/&shadda;/\x{0651}/g;

  $str =~ s/&alif_maqsura;/\x{0649}/g;
  $str =~ s/&ta_marbuta;/\x{0629}/g;
  $str =~ s/&alif_hamza_sure;/\x{0623}/g;
  $str =~ s/&alif_hamza_sube;/\x{0625}/g;
  $str =~ s/&alif_madda;/\x{0622}/g;
  $str =~ s/&alif_wasla;/\x{0671}/g;
  $str =~ s/&ya_hamza;/\x{0626}/g;
  $str =~ s/&waw_hamza;/\x{0624}/g;
  $str =~ s/&hamza;/\x{0621}/g;

  $str =~ s/&ar_komo;/\x{060C}/g;
  $str =~ s/&ar_dekumakomo;/\x{066B}/g;
  $str =~ s/&ar_punktokomo;/\x{061B}/g;
  $str =~ s/&ar_demandopunkto;/\x{061F}/g;
  $str =~ s/&ar_0;/\x{0660}/g;
  $str =~ s/&ar_1;/\x{0661}/g;
  $str =~ s/&ar_2;/\x{0662}/g;
  $str =~ s/&ar_3;/\x{0663}/g;
